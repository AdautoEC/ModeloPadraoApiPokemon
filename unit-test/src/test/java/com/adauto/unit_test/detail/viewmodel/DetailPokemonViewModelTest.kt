package com.adauto.unit_test.detail.viewmodel
...
import com.adauto.unit_test.TestCoroutineRule
import com.adauto.unit_test.detail.repository.FakeDetailPokemonRepository
import com.adauto.unit_test.getOrAwaitValueTest
...
class DetailPokemonViewModelTest {
    ...
    fun `get pokemon detail MAY BE get error`() {
        testCoroutineRule.runBlockingTest {
            doReturn(
                Response.error<com.adauto.shared_domain.detail_pokemon.DetailPokemonDTO>(
                    HTTP_INTERNAL_ERROR,
